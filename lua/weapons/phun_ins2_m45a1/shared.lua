...
SWEP.ViewModel = "models/gmod4phun/ins2/weapons/v_m45.mdl"
SWEP.WorldModel = "models/gmod4phun/ins2/weapons/w_m45.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = surface.GetTextureID("gmod4phun/ins2/icons/weapon_m45")
end
...
SWEP.VElements = {
	["default_mag"] = {model = "models/gmod4phun/ins2/upgrades/a_magazine_m45_8.mdl", default = true, bonemerge = true},
	["pb_ins2_att_mag_extended_15"] = {model = "models/gmod4phun/ins2/upgrades/a_magazine_m45_15.mdl", bonemerge = true},
...
local icon_merge_models = {
	"models/gmod4phun/ins2/upgrades/a_magazine_m45_8.mdl"
}
