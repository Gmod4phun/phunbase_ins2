...
if CLIENT then
	SWEP.WepSelectIcon = surface.GetTextureID("gmod4phun/ins2/icons/weapon_galil_sar")
end
...
SWEP.INS2_IconParams = {dist = 15, offset = 1, spin = false, mergemodels = icon_merge_models}
