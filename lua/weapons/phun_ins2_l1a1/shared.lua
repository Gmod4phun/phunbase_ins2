...
// same stuf as FAL
PHUNBASE.LoadLua("weapons/phun_ins2_fal/sequences.lua")
PHUNBASE.LoadLua("weapons/phun_ins2_fal/sounds.lua")
...
SWEP.ViewModel = "models/gmod4phun/ins2/weapons/v_l1a1.mdl"
SWEP.WorldModel = "models/gmod4phun/ins2/weapons/w_l1a1.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = surface.GetTextureID("gmod4phun/ins2/icons/weapon_l1a1")
end
...
SWEP.VElements = {
	["standard"] = {model = "models/gmod4phun/ins2/upgrades/a_standard_l1a1.mdl", default = true, bonemerge = true},
	["modkit"] = {model = "models/gmod4phun/ins2/upgrades/a_modkit_l1a1.mdl", bonemerge = true},
	
	["mag_20"] = {model = "models/gmod4phun/ins2/upgrades/a_magazine_l1a1_20.mdl", default = true, bonemerge = true},
...
SWEP.AttachmentIronsights = {
	["pb_ins2_att_optic_holo"] = {pos = Vector(-2.4707, -2, -0.235), ang = opticAng},
	["pb_ins2_att_optic_reddot"] = {pos = Vector(-2.47, -2, -0.27), ang = opticAng},
	["pb_ins2_att_optic_2xreddot"] = {pos = Vector(-2.47, -2, -0.2819), ang = opticAng},
	["pb_ins2_att_optic_elcan"] = {pos = Vector(-2.4738, -2, -0.3768), ang = opticAng},
...
SWEP.INS2_IconParams = {dist = 20, offset = 3.25, spin = false, mergemodels = icon_merge_models}
